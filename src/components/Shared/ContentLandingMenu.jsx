...
const ContentLandingMenu = ({ children, title }) => {
  ...
  return (
    ...
    >
        <h2 className="text-xl font-bold lg:text-4xl text-center">{title}</h2>
        {/* <div className="w-full h-[1px] bg-black bg-opacity-40"></div> */}
        <div className="flex flex-col rounded-md overflow-hidden">
            {children}
        </div>
        <Link className="flex items-center self-center text-xl lg:text-xl lg:hover:pl-2 duration-150 text-blue-600">
