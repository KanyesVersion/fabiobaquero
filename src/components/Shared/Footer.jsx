  ...
  return (
    <footer className="py-12 px-12 lg:px-20 text-md lg:text-lg bg-gray-900 text-white flex justify-between items-center">
        ...
        <div className="flex flex-col gap-4">
            ...
            <Link className="flex gap-2 items-center hover:text-sky-300"><i className="fa fa-facebook-official" aria-hidden="true"></i>Facebook</Link>
            <Link className="flex gap-2 items-center hover:text-sky-300"><i className="fa fa-youtube-play" aria-hidden="true"></i>Youtube</Link>
        </div>
    </footer>
  )
}
